...
fn with_header(path: &str, content: String) -> String {
    opensdk_core::header::with_file_header(path, content)
}
...
pub const EMITTER: opensdk_core::emitter::EmitterFns =
    opensdk_core::emitter::EmitterFns::new("ruby", generate_ruby)
...
pub fn generate_ruby_files(
    ...
    opensdk_core::emitter::attach_write_modes("ruby", generate_ruby_with(spec, options))
}
