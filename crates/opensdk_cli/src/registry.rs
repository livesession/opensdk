...
//! inside `opensdk_core` would make core depend on all seven emitter
...
use opensdk_core::emitter::{resolve_language, EmitterFns, GeneratedFile};
...
pub static EMITTERS: &[EmitterEntry] = &[
    EmitterEntry {
        fns: &opensdk_go::EMITTER,
        generate_files: opensdk_go::generate_go_files,
    },
    EmitterEntry {
        fns: &opensdk_python::EMITTER,
        generate_files: opensdk_python::generate_python_files,
    },
    EmitterEntry {
        fns: &opensdk_node::EMITTER,
        generate_files: opensdk_node::generate_node_files,
    },
    EmitterEntry {
        fns: &opensdk_ruby::EMITTER,
        generate_files: opensdk_ruby::generate_ruby_files,
    },
    EmitterEntry {
        fns: &opensdk_java::EMITTER,
        generate_files: opensdk_java::generate_java_files,
    },
    EmitterEntry {
        fns: &opensdk_dotnet::EMITTER,
        generate_files: opensdk_dotnet::generate_dotnet_files,
    },
    EmitterEntry {
        fns: &opensdk_rust::EMITTER,
        generate_files: opensdk_rust::generate_rust_files,
    },
];
