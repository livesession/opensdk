...
pub(crate) fn with_py_header(content: &str) -> String {
    ...
    opensdk_core::header::with_file_header("x.py", content.to_string())
}
...
pub const EMITTER: opensdk_core::emitter::EmitterFns =
    opensdk_core::emitter::EmitterFns::new("python", generate_python)
...
pub fn generate_python_files(
    ...
    opensdk_core::emitter::attach_write_modes("python", generate_python_with(spec, options))
}
