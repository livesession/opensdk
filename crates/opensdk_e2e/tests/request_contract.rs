...
/// `crates/opensdk_e2e`, not the repo root.
fn corpus(lang: &str) -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .join(format!("../opensdk_{lang}/__fixtures__/-2.complex.openai"))
}
...
/// Rust is absent on purpose: `opensdk_rust` has a 239-case corpus and no
