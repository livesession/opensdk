...
//! (`opensdk_framework`), the breaking-change classifier
//! (`opensdk_diff`), the config schema (`opensdk_config`), the chain
//! source engine (`opensdk_chain`), the converters and the seven emitters.
//!
